        ...
        if (tiklandi== true){
            ...
            if(sayi != 0){
                Row(
                    ...
                    var sonuc2= mutableListOf<String>()
                    var sonuc3= mutableListOf<String>()
                    var sonuc4= mutableListOf<String>()
                    var sonuc5= mutableListOf<String>()
                    var sonuc6= mutableListOf<String>()
            ...
            if(sayi != 0){
                Row(
                    ...
                    while (i< sayi){
                        sonuc2.add(generateLotoNumbers())
                        i+=1
                    }
                    ...
                    while (j< sayi){
                        Column(
                            ...
                            Text(text = sonuc2[j],color = Color(49, 48, 77) )
                            j++;
                        }
                        Column (
                            modifier = Modifier
            ...
            if(sayi != 0){
                Row(
                    ...
                    while (i< sayi){
                        sonuc3.add(generateLotoNumbers())
                        i+=1
                    }
                    ...
                    while (j< sayi){
                        Column(
                            ...
                            Text(text = sonuc3[j],color = Color(49, 48, 77) )
                            j++;
                        }
                        Column (
                            modifier = Modifier
            ...
            if(sayi != 0){
                Row(
                    ...
                    while (i< sayi){
                        sonuc4.add(generateLotoNumbers())
                        i+=1
                    }
                    ...
                    while (j< sayi){
                        Column(
                            ...
                            Text(text = sonuc4[j],color = Color(49, 48, 77) )
                            j++;
                        }
                        Column (
                            modifier = Modifier
            ...
            if(sayi != 0){
                Row(
                    ...
                    while (i< sayi){
                        sonuc5.add(generateLotoNumbers())
                        i+=1
                    }
                    ...
                    while (j< sayi){
                        Column(
                            ...
                            Text(text = sonuc5[j],color = Color(49, 48, 77) )
                            j++;
                        }
                        Column (
                            modifier = Modifier
            ...
            if(sayi != 0){
                Row(
                    ...
                    while (i< sayi){
                        sonuc6.add(generateLotoNumbers())
                        i+=1
                    }
                    ...
                    while (j< sayi){
                        Column(
                            ...
                            Text(text = sonuc6[j],color = Color(49, 48, 77) )
                            j++;
                        }
                        Column (
                            modifier = Modifier
